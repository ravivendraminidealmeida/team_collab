defmodule TeamCollabWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: TeamCollabWeb.Gettext
  ...
  ## Examples
      <.company_logo />
      <.company_logo class="size-8"/>
  """
  attr :class, :string, default: "size-4"

  def company_logo(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" class={@class} fill="none" viewBox="0 0 40 40">
      <path
        fill="#F06225"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TeamCollabWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TeamCollabWeb.Gettext, "errors", msg, opts)
    end
  end
